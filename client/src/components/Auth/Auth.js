  ...
  return (
    <>
      ...
      <div className="login-container">
        ...
        <form onSubmit="return false;" method="POST" className="form login">
          <div className="form__field form__field--email">
            <label className="label label--icon" for="login__email">
              <svg className="icon">
          ...
          <div className="form__field form__field--password">
            <label className="label label--icon" for="login__password">
              <svg className="icon">
          ...
          <div className="login-actions-container">
            <div className="form__field form__field--remember-me">
              <label className="label label--remember-me" for="login__remember-me">
